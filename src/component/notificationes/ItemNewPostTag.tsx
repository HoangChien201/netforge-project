...
const ItemNewPostTag:React.FC<Item> = ({ notification }) => {
    ...
    return (
        ...
        <View style={styles.iconFriend} >
            ...
            <Icon style={styles.iconHeart} name='person-pin' size={18} color={COLOR.PrimaryColor} />
        </View>
